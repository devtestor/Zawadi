...
import { ArrowLeft, ArrowDownCircle, ArrowUpCircle, Lock, RefreshCw } from "lucide-react-native";
    ...
    <View style={{ flex: 1, backgroundColor: "#0A0A0F" }} testID="wallet-screen">
      ...
      {isLoading || !data ? (
        ...
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 100, gap: 16 }}>
          ...
          <View style={{ backgroundColor: "#1E1E0A", borderRadius: 20, borderWidth: 1, borderColor: "#D4A84366", padding: 24 }}>
            ...
            <View style={{ flexDirection: "row", gap: 10, marginTop: 18 }}>
              ...
              <Pressable
                ...
                onPress={() => Alert.alert("Withdrawals", "Coming soon — contact support to cash out.")}
          ...
          {/* Recent activity */}
          <View>
            <Text style={{ color: "#FFFFFF", fontSize: 16, fontWeight: "800", marginBottom: 8 }}>Recent activity</Text>
